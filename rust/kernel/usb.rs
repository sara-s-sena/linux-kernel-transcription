...
pub trait Driver {
    ...
    /// Implements should attempt to initialize the interface here.
    fn probe(
...
unsafe impl AlwaysRefCounter for Interface {
    fn inc_ref(&self) {
...
// SAFETY: It is safe to send a &Interface to another thread becase we do not 
...
/// kernel.
///
/// [`struct usb_device`]: https://www.kernel.org/doc/html/latest/driver-api/usb.html#c.usb_device
#[repr(transparent)]
