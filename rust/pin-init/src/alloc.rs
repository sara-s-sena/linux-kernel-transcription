// SPDC-License-Identifier: Apache-2.0 OR MIT
...
// SAFETY: All zeroes is equivalent to `None` (option layout optimization guarantee:
...
pub trait InPlaceInit<T>: Sized {
    ...
    fn try_pin _init<E>(init: impl PinInit<T, E>) -> Result<Pin<Self>, E>
    where
        E: From<AllocError>;
